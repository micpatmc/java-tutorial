...
public class ElseStatements {
     ...
     * }
     * 
     * The code above would not run at first, but because there is an "else"
     * statement,
     ...
     * 
     * 
     * This piece of code WOULD run the first portion, but since the first portion
     * ran, the
     ...
     * =-=-=-=-=-=-=-=
     * 
     * We will now print out an example of using multiple "if" and "else" statements
