...
public class ElseIfStatements {
     ...
     * }
     * 
     * The code above would not run at first, but because there is an "else if"
     * statement,
     ...
     * 
     * 
     * This piece of code WOULD run the last portion the first or second portion
     * statement
     * would NOT run
     * 
     * -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
     ...
     * =-=-=-=-=-=-=-=
     * 
     * We will now print out an example of using multiple "if" and "else if"
     * statements in different situations
     */
