...
public class Hashmap 
{
    /*
        ...
        To check if a value is contained inside of a HashMap, you use the "containsValue" keyword
        ...
        To remove anything from a HashMap, you have to use the "remove" keyword with the key value
