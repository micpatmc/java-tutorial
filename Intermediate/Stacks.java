...
public class Stacks {
     ...
     * =-=-=-=-=-=-=-=
     * 
     * Another function we are able to do is "pop" the number from the Stack, which
     * will ALWAYS
     ...
     * =-=-=-=-=-=-=-=
     * 
     * A function that Stacks use that is also important is stack.peek() to look at
     * whatever
     ...
     * ------
     * 
     * "num" is equal to "42", but "42" is still in the Stack because it was only
     * read and
     ...
     * =-=-=-=-=-=-=-=
     * 
     * Lastly, an important function for Stacks is stack.isEmpty() which will check
     * if the Stack
     * is empty or not
     * 
