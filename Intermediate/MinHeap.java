...
public class MinHeap 
{
    ...
    // Queue<Integer> minHeap = new PriorityQueue<>(); // Java doesn't have an actual "Min-Heap" interface, so a "PriorityQueue" is used instead
    ...
    // Now, the number "12" is at the top of the Min-Heap because it's smaller than "42"
    // and the Min-Heap is ordered so smaller values are at the top and larger on the bottom

    // -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
    // -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
    
    // Another function we are able to do is "poll" the number from the Min-Heap, which will ALWAYS
    ...
    // "num" is now equal to "12" because that was the number at the top of the Min-Heap

    // -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
    // -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=

    // A function that Min-Heaps use that is also important is minHeap.peek() to look at whatever
    ...
    // "num" is equal to "42", but "42" is still in the Min-Heap because it was only read and 
    // not polled from the Min-Heap

    // -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
    // -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=

    // Lastly, an important function for Min-Heap is minHeap.isEmpty() which will check if the Queue
    // is empty or not
