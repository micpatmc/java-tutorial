...
class Food
{
    ...
    // You always have to name the Constructor the same name as the class, in this case "Food"
...
// We will now initialize the "Food" object, giving it an arbitrary amount of calories
